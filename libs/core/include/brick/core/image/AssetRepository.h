...
public:
    AssetRepository(brick::interfaces::display::IAssetSource* flash = nullptr,
                    brick::interfaces::display::IAssetSource* psram = nullptr,
                    brick::interfaces::display::IAssetSource* usb_or_sd = nullptr)
    ...
    brick::interfaces::display::IAssetSource* source() const {
        switch (storage_) {
        case brick::interfaces::display::AssetStorage::flash_partition: return flash_;
        case brick::interfaces::display::AssetStorage::psram_cache: return psram_;
        case brick::interfaces::display::AssetStorage::usb_or_sd: return usb_or_sd_;
        }
        return nullptr;
    }
