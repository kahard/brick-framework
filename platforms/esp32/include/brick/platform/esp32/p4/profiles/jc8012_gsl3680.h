...
inline touch::Gsl3680Config jc8012_gsl3680(brick::interfaces::display::Rotation rotation = brick::interfaces::display::Rotation::rotate_0)
{
    ...
    config.sda_gpio=GPIO_NUM_7; config.scl_gpio=GPIO_NUM_8; config.reset_gpio=GPIO_NUM_22; config.interrupt_gpio=GPIO_NUM_21;
    ...
    config.mirror_y=mirrored_y; config.swap_xy=swapped; return config;
}
}
