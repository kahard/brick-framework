...
class ArduinoSerialLogger final : public brick::interfaces::logging::ILogger
{
public:
    explicit ArduinoSerialLogger(int minimum_level = 0) : minimum_level_(minimum_level) {}
...
{
public:
    void write(brick::interfaces::logging::Level, const char*, const char*, va_list) override {}
};
